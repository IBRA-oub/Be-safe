<?php
 ...
 require_once '../../Controllers/PrimeController/DisplayPrimeController.php';
        ...
        <div class="flex items-center justify-between">
            ...
            <div>
                ...
                <button class="bg-[#212529] text-white w-[160px] h-[50px] rounded-md" id="addBank">
                    <a href="addPrime.php">Add Prime</a>
                </button>
            </div>
        </div>
        ...
        <div class="hidden md:block  rounded-lg overflow-hidden mt-10">
           ...
           w-full   " id="table1">
                ...
                <tbody class="sm:w-full">
                    ...
                    <?php 
              foreach($PrimeData as $preData) {
              ?>
                    <tr class=" pt-10 sm:pt-0  w-full ">

                        <td class=" sm:text-center text-right">
                            <?php echo  $preData['Premium_ID'] ?>
                        </td>


                        <td class=" sm:text-center text-right">
                            <?php echo $preData['Amount'] ?>
                        </td>
                        <td class=" sm:text-center text-right">
                            <?php echo $preData['Date'] ?>
                        </td>
                        <td class=" sm:text-center text-right">
                            <button class="bg-[#212529] text-white w-[35px] h-[35px] rounded-md">
                                <a href="updatePrime.php?Premium_ID=<?= $preData['Premium_ID'];?>">
                            ...
                            <button class="bg-[#212529] text-white w-[35px] h-[35px] rounded-md">
                                <a
                                    href="../../Controllers/PrimeController/DeletePrimeController.php?Premium_ID=<?= $preData ['Premium_ID'];?>"><i
              ...
              ?>
                    <tr class="block pt-10 sm:pt-0   w-full ">
                        ...
                        <td data-label="id"
                            ...
                            <?php echo  $claiData['Premium_ID'] ?>
                        </td>

                        <td data-label="Description" class="border-b before:content-['Amount'] before:absolute before:left-0 before:w-1/2 before:font-bold before:text-left before:pl-2 block  sm:before:hidden sm:text-center 
                             text-right">
                            <?php echo  $claiData['Amount'] ?>
                        </td>
                        ...
                        <td data-label="ACtion"
                            ...
                            <button class="bg-slate-900 text-white w-[35px] h-[35px] rounded-md">
                                <a href="updateClaim.php?Premium_ID=<?= $preData ['Premium_ID'];?>">
                                    <i class="fa-solid fa-pen"></i></a>

                            </button>
                            <button class="bg-slate-900 text-white w-[35px] h-[35px] rounded-md">
                                <a
                                    href="../../Controllers/ClaimController/DeleteClaimController.php?Premium_ID=<?= $preData ['Premium_ID'] ;?>"><i
