...
<head>
    ...
    <title>AddAssurance</title>
</head>

<body>
    <!--================form-add-Assurance================ -->
    <section class="max-w-4xl p-6 mx-auto bg-gray-600 rounded-md shadow-xl shadow-gray-500  mt-52">
        <h1 class="text-xl font-bold text-white capitalize dark:text-white">Add Assurance</h1>
        <form action="../../Controllers/AssuranceController/AddAssurance.php" method="POST"
            ...
            <div class="flex justify-end mt-6">
                <button
                    class="px-10 py-2 leading-5 text-black transition-colors duration-200 transform bg-white rounded-md hover:bg-gray-800 hover:text-white focus:outline-none focus:bg-gray-600">Save</button>
            </div>
        </form>
    </section>
